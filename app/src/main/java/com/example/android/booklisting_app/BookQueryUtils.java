 ...
 */
final class BookQueryUtils {

    /** Tag for the log messages */
    private static final String LOG_TAG = BookQueryUtils.class.getSimpleName();
        ...
        try {
            ...
            if (baseJsonResponse.has("items")) {
                ...
                for (int i = 0; i < itemsArray.length(); i++) {
                    ...
                    // Create a new {@link Book} object with the title, authors and link.
                    // from the JSON response.
                    Book mBook = new Book(title, authorList, link);
